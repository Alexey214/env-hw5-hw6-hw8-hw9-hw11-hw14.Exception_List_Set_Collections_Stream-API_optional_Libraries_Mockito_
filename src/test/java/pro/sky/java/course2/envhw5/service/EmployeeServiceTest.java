...
import pro.sky.java.course2.envhw5.constants.Constants;
...
class EmployeeServiceTest {
    ...
    void addEmployeeWhitCorrectName() {
        String result = out.addEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
    ...
    @Test
    void reAddEmployee() {
        out.addEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
        String result = out.addEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
    ...
    void deleteEmployeeWhitCorrectName() {
        out.addEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
        String result = out.deleteEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
        assertTrue(result.contains(DEFAULT_FULL_NAME));
    ...
    void deleteNotFoundEmployee() {
        out.addEmployee(DEFAULT_LASTNAME, DEFAULT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
        String result = out.deleteEmployee(NOT_CORRECT_LASTNAME, NOT_CORRECT_FIRSTNAME, Constants.MAX_SALARY, DEFAULT_DEPARTMENT);
        assertFalse(result.contains(NOT_CORRECT_FULL_NAME));
